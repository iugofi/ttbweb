            ...
            if (storeId) {
                $.ajax({
                    ...
                    $.each(response.admindata, function(key, item) {
                        ...
                        var passwordField = 
                            '<div class="flex">' +
                                '<input type="password" class="form-control block w-full text-[0.875rem] !rounded-md" id="password_' + item.id + '" name="password" value="' + item.decrypted_password + '" disabled>' +
                        ...
                        var row = '<tr>' +
                            ...
                            '<td class="border px-4 py-2">' + item.name + '</td>' +
                            '<td class="border px-4 py-2">' + item.username + '</td>' +
                            '<td class="border px-4 py-2">' + passwordField + '</td>' +
                            '<td class="border px-4 py-2">' +
                                '<div class="flex items-center font-semibold">' +
                                    '<span class="!me-2 inline-flex justify-center items-center">' +

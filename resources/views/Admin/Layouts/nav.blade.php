                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Sign
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide"><a href="signup-basic.html" class="side-menu__item">Basic</a>
                                </li>
                                <li class="slide"><a href="signup-cover.html" class="side-menu__item">Cover</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Sign
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide"><a href="signin-basic.html" class="side-menu__item">Basic</a>
                                </li>
                                <li class="slide"><a href="signin-cover.html" class="side-menu__item">Cover</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide">
                                    <a href="job-candidate-search.html" class="side-menu__item">Job Candidate
                                        Search</a>
                                </li>
                                <li class="slide">
                                    <a href="job-candidate-details.html" class="side-menu__item">Job Candidate
                                        Details</a>
                                </li>
                            </ul>
                        </li>

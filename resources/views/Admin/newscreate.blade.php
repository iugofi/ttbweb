                        ...
                        <div class="box-body">
                            <div class="grid grid-cols-12 gap-4">
                                ...
                                <div class="xl:col-span-12 col-span-12">
                                    ...
                                    <textarea id="content" name="content" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500" rows="12" required></textarea>
                                </div>

...
@section('title', 'User Visitor List')
@section('Description', '')
@section('keywords', '')
                                ...
                                <tbody>
                                    @foreach ($visitor as $key => $item)
                                        <tr>
                                            ...
                                            <td class="border px-4 py-2">{{ $item->browser }}</td>                               
                                            <td class="border px-4 py-2">{{ $item->live }}</td>                               
                                            <td class="border px-4 py-2">{{ $item->last_active }}</td>                               

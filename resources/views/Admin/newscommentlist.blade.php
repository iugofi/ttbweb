...
@section('title', 'News Comment List')
@section('Description', '')
@section('keywords', '')
    ...
    <div class="content">
                                            ...
                                            <tr>
                                                ...
                                                <td class="border px-4 py-2">
                                                    <div class="flex flex-row items-center !gap-2 text-[0.9375rem]">
                                                        <a aria-label="anchor"
                                                            href="{{ route('edit.newscommentedit',  \Crypt::encrypt($item->id)) }}"
                                                        ...
                                                        <button aria-label="button" type="button"
                                                            class="ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-danger-full btn-wave delete-news-comment"
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('click', '.delete-news-comment', function() {
                    var itemId = $(this).data('item-id');
                    var url = "{{ route('delete.newscommentdelete', ':id') }}";

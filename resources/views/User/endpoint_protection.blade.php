                ...
                <div class="grid lg:grid-cols-12 md:grid-cols-12 sm:grid-cols-12 justify-center align-center tab-css">
                    <div class="xxl:col-span-12 xl:col-span-12 lg:col-span-12 pt-5 pb-3 lg:px-2 !text-start px-12 my-auto">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 gap-4 endpoint-content" style="display: flex; justify-content: center;">
                            <div class="xxl:col-span-4 xl:col-span-4 lg:col-span-4 col-span-12 inline-flex">
                                <img src=" {{ asset('assets/img/24-7-icon.png') }}" class="img-fluid endpoint-icon p-1 mt-3 w-100" style="width:90px; height:90px">
                                <div class="icon-txt ms-4 mr-[1.0rem]">
                ...
                <div
                    ...
                    <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-12 text-center">
                        <div class="lg:text-start !flex items-center lg:justify-start justify-center">
                            <img src="{{ asset('assets/img/What-do-TTB-Endpoint-Security-Services-offer-you.png') }}" alt="" class="img-fluid">
                        </div>
                    </div>
                ...
                <div class="container main-banner-container">
                    <section class="testimonial-area">
                        <div class="container">
                            ...
                            <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2750px, 0px, 0px); transition: 1s; width: 11000px;"><div class="owl-item cloned" style="width: 542px; margin-right: 8px;"><div class="single-testimonial carousel-slide single-testimonial p-4">

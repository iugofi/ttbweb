    ...
    <div class="about-container mb-6">
            ...
            <div class="aboutus-banner-content container">
                <div class="grid grid-cols-12 sm:gap-x-6">
                    <div class="xxl:col-span-6 xl:col-span-6 col-span-12">
                        <div class="p-4 text-start mb-6">
                            ...
                            <h3 class="font-semibold mb-2 text-[1.75rem]">
                                TTB IS  <span class="text-success">WHAT</span>
                    ...
                    <div class="xxl:col-span-6 xl:col-span-6 col-span-12 aboutus-img aboutus-banner-img">
                        <img src="https://php.spruko.com/tailwind/ynex/ynex/assets/images/media/media-80.svg" class="img-fluid !w-full !h-[17.5rem] !z-[1]" alt="">
                    </div>
        ...
        <div class="!max-w-[40rem] !justify-center !mx-auto !items-center mb-[3rem]">
            <div class="text-start">
                ...
                <p class="text-[.875rem] mb-6 text-[#8c9097] dark:text-white/50">TTB is passionate about protecting businesses and consumers from online threats. Our solutions offer complete protection from ransomware, viruses, and identity theft for your Windows devices without slowing them down.
                    As a leading cybersecurity firm, we are on a mission to provide advanced system security solutions to our customers. We offer all the necessary tools for protecting online data from the most common forms of threats like data theft, ransomware, malware, and more.
                    Our security expertise is constantly transforming into specialized cybersecurity services and solutions for businesses around the world. The company, which is built upon a foundation of trust, believes that there should be a built-in layer of security for every transaction you make. Our goal is to implement a number of innovative security measures in place and deploy solutions to solve the greatest security challenges. We aim to block threats from unknown viruses, we tend to detect, analyze and classify malware in real-time without interrupting the speed and overall system performance.</p>
                <div>
                    <div class="flex mb-6">

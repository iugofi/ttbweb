    ...
    <div class="container">
        <div class="grid grid-cols-12 gap-6">
            <div class="xl:col-span-4 col-span-12">
                <div class="px-6">
                    <p class="font-semibold mb-4"><a aria-label="anchor" href="{{ route('user.index') }}"><img
                                src="{{ asset('assets/images/brand-logos/favicon.png') }}" alt=""></a></p>
                    ...
                    <p class="mb-0  font-normal">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Autem ea esse
                        ad</p>
                </div>
            </div>
            <div class="xl:col-span-2 col-span-12">
                <div class="px-6">
                    ...
                    <ul class="list-unstyled  font-normal landing-footer-list">
                        ...
                        <li class="slide">
                            <a href="{{ route('user.virus_removal_service') }}" class="side-menu__item">virus removal
                                service</a>
                        </li>
                        <li class="slide">
                            <a href="{{ route('user.E_Support_Concierge') }}" class="side-menu__item">E Support
                                Concierge</a>
                        </li>
                    </ul>
                </div>

...
@section('content')
    ...
    <div class="main-content !p-0 landing-main dark:text-defaulttextcolor/70">
                ...
                <div class="container network-container">
                    <div class="grid grid-cols-12 gap-6">
                        <div class="xxl:col-span-12 xl:col-span-12 lg:col-span-12 col-span-12">
                            <div class="lg:py-[3rem] text-vartical" style="position: relative; top: 12rem;">
            ...
            <div class="container">
                <div class="grid grid-cols-12 gap-6">
                    <div class="xxl:col-span-12 xl:col-span-12 lg:col-span-12 md:col-span-12 col-span-12 text-center">
                        <h2>Introduction</h2>
                        <p class="mt-5">Generally, network protection involves multi-layered defense to keep the users,
                            infrastructure,
            ...
            <div class="container">
                <div class="grid grid-cols-12 gap-6">
                    <div class="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-6 col-span-12 border-box-sct">
                        ...
                        <h4 class="mt-5">Core Components</h4>
        ...
        <section class="net-prot-sec-four">
            <div class="container">
                <div class="grid grid-cols-12 gap-6">
                    <div class="xxl:col-span-12 xl:col-span-12 lg:col-span-12 md:col-span-12 col-span-12 text-center">

...
@section('content')
    ...
    <div class="main-content !p-0 landing-main dark:text-defaulttextcolor/70">
        ...
        <section class="section !bg-[#f9fafb] dark:!bg-black/10 section-bg text-defaulttextcolor dark:text-defaulttextcolor/70"
            ...
            <div class="container network-container" style="height: 8rem;">
                <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="xl:col-span-4 col-span-12">
                                <div class="box">
                                    ...
                                    <div class="box-body text-[0.9rem] text-center network-box-bm">
                                        ...
                                        <a href="#" class="read-btn font-bold">Read More<i
                                                class="fe fe-chevron-right font-bold rte-icon"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="xl:col-span-4 col-span-12">
            ...
            <div class="container main-banner-container">
                <div
                    ...
                    <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 customize-image text-center">
                        <div class="lg:text-start !flex items-center lg:justify-start justify-center">
                            <img src="{{ asset('assets/img/second-last-section.png') }}" alt="" class="img-fluid">
                        </div>

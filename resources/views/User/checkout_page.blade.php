        ...
        <div class="main-content">
            <div class="container my-[3rem] ">
                <div class="grid grid-cols-12 gap-6 mt-6">
                    <div class="xl:col-span-8 col-span-12">
                        <div class="team-members" id="team-members">
                            <div class="grid grid-cols-12 gap-x-6">
                                <div class="xl:col-span-12 col-span-12 xl:order-1 md:order-1 sm:order-1">
                                    <div class="box">
                                        <div class="box-body">
                                ...
                                <div class="xl:col-span-12 col-span-12 xl:order-2 md:order-2 sm:order-3">
                                    <div class="box">
                    ...
                    <div class="xl:col-span-4 col-span-12 xl:order-3 md:order-3 sm:order-2">
                        <div class="team-groups">
                            <div class="box">
                                ...
                                <div
                                    ...
                                    <div class="box">
                                        <div class="box-body">
                                            <img src="assets/img/ttb antivirus box design.jpg"
                                                class="card-img mb-4 !rounded-md" alt="...">

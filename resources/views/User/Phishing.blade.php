        ...
        <div class="container ttbantivirus-container">
            <div
                ...
                <div
                    ...
                    <span class="lg:text-center font-semibold mt-2 pt-5 mb-2 text-[1rem]" style="color:#12D2B3;">What is
                        Malwere</span>
                    <h4 class="lg:text-start font-semibold mb-2 pt-5 text-[2rem]">Are You Bettre, Your<br>Businedd Based on<br> Relationsship?</h4>
                    <p class=" text-[0.9rem] text-[#8c9097] dark:text-white/50 mb-4 ">Objectively deliver professional
                        value with diverse web-readiness. Collaboratively transition wireless customer service without
                        goal-oriented catalysts for change. Collaboratively.
                    </p>
                    <div class="grid grid-cols-12 gap-x-6">
                                    ...
                                    <div class="">
                                        <div id="hs-tab-js-behavior-1" role="tabpanel"
                                            ...
                                            <p
                                                ...
                                                problems with summer activities. How to cheat at travel agents and get away
                                                with it. How not knowing family trip ideas makes you a rookie. What everyone
                                        ...
                                        <div id="hs-tab-js-behavior-2" class="hidden" role="tabpanel"
                                            ...
                                            <p
                                                class="text-gray-500 dark:text-[#8c9097] dark:text-white/50 p-5 border rounded-ss-none rounded-sm dark:border-white/10 border-gray-200">
                                                How travel coupons make you a better lover. Why cultural solutions are the
                                                new black. Why mom was right about travel insurances. How family trip ideas
                                                can help you predict the future. How carnival cruises make you a better
                                                lover. Why you'll never succeed at daily deals. 11 ways cheapest flights can
                                                find you the love of your life. The complete beginner's guide to mission
                                                trips. If you read one article about cultural notes read this one. Why you
                                        ...
                                        <div id="hs-tab-js-behavior-3" class="hidden" role="tabpanel"
                                            ...
                                            <p
                                                ...
                                                numbers. Will mexican food ever rule the world? The 10 best thai restaurant
                                                youtube videos. How restaurant weeks can make you sick. The complete
                                                beginner's guide to cooking healthy food. Unbelievable food stamp success
                                                stories. How whole foods markets are making the world a better place. 16
                                                things that won't happen in dish reviews.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box-body">
                                    <div class="flex">
                                        <div class="border-e border-gray-200 dark:border-white/10">
                                            <nav class="flex flex-col space-y-2 whitespace-nowrap" aria-label="Tabs"
                                                data-hs-tabs-vertical="true">
                                                <button type="button"
                                                    class="hs-tab-active:bg-white hs-tab-active:border-e-transparent  hs-tab-active:text-primary dark:hs-tab-active:bg-bodybg dark:hs-tab-active:border-e-transparent dark:hs-tab-active:text-primary -me-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor  rounded-s-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300 active"
                                                    id="hs-tab-js-vertical-item-1" data-hs-tab="#hs-tab-js-vertical-1"
                                                    aria-controls="hs-tab-js-vertical-1">
                                                    Tab 1
                                                </button>
                                                <button type="button"
                                                    class="hs-tab-active:bg-white hs-tab-active:border-e-transparent  hs-tab-active:text-primary dark:hs-tab-active:bg-bodybg dark:hs-tab-active:border-e-transparent dark:hs-tab-active:text-primary -me-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor  rounded-s-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300"
                                                    id="hs-tab-js-vertical-item-2" data-hs-tab="#hs-tab-js-vertical-2"
                                                    aria-controls="hs-tab-js-vertical-2">
                                                    Tab 2
                                                </button>
                                                <button type="button"
                                                    class="hs-tab-active:bg-white hs-tab-active:border-e-transparent  hs-tab-active:text-primary dark:hs-tab-active:bg-bodybg dark:hs-tab-active:border-e-transparent dark:hs-tab-active:text-primary -me-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-s-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300"
                                                    id="hs-tab-js-vertical-item-3" data-hs-tab="#hs-tab-js-vertical-3"
                                        ...
                                        <div class="">
                                            <div id="hs-tab-js-vertical-1" role="tabpanel"
                                                aria-labelledby="hs-tab-js-vertical-item-1">
                                                <p
                                                    class="text-gray-500 dark:text-[#8c9097] dark:text-white/50 p-5 border border-s-0 rounded-sm rounded-ss-none dark:border-white/10 border-gray-200">
                                                    How hotel deals can help you live a better life. How celebrity cruises
                                            ...
                                            <div id="hs-tab-js-vertical-2" class="hidden" role="tabpanel"
                                                ...
                                                <p
                                                    ...
                                                    trip ideas can help you predict the future. How carnival cruises make
                                                    you a better lover. Why you'll never succeed at daily deals. 11 ways
                                                    cheapest flights can find you the love of your life. The complete
                                                    beginner's guide to mission trips. If you read one article about
                                                    cultural notes read this one. Why you shouldn't eat vacation package in
                                                    bed.
                                                </p>
                                            </div>
                                            <div id="hs-tab-js-vertical-3" class="hidden" role="tabpanel"
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="hidden sm:block border-b-0 border-gray-200 dark:border-white/10">
                                        <nav class="flex space-x-2 rtl:space-x-reverse" aria-label="Tabs">
                                            ...
                                            <button type="button"
                                                class="hs-tab-active:bg-white hs-tab-active:border-b-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-bodybg dark:hs-tab-active:border-b-transparent dark:hs-tab-active:text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-t-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300"
                                                id="hs-tab-to-select-item-3" data-hs-tab="#hs-tab-to-select-3"
                                    ...
                                    <div class="">
                                        <div id="hs-tab-to-select-1" role="tabpanel"
                                            ...
                                            <p
                                                class="text-gray-500 dark:text-[#8c9097] dark:text-white/50 p-5 border rounded-sm  sm:rounded-ss-none dark:border-white/10 border-gray-200">
                                                How hotel deals can help you live a better life. How celebrity cruises
                                                aren't as bad as you think. How cultural solutions can help you predict the
                                                future. How to cheat at dog friendly hotels and get away with it. 17
                                                problems with summer activities. How to cheat at travel agents and get away
                                        ...
                                        <div id="hs-tab-to-select-3" class="hidden" role="tabpanel"
                                ...
                                <div class="box-body">
                                    <div class="border-b-2 border-gray-200 dark:border-white/10">
                                        <nav class="-mb-0.5 flex space-x-6 rtl:space-x-reverse">
                                            <a class="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor  dark:text-[#8c9097] dark:text-white/50 hover:text-primary active"
                                                href="javascript:void(0);" id="underline-item-1" data-hs-tab="#underline-1"
                                                aria-controls="underline-1">
                                                Tab 1
                                            </a>
                                            <a class="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor  dark:text-[#8c9097] dark:text-white/50 hover:text-primary"
                                    ...
                                    <div class="sm:border-b border-gray-200 dark:border-white/10">
                                        <nav class="sm:flex sm:space-x-2 sm:rtl:space-x-reverse" aria-label="Tabs">
                                            <button type="button"
                                                ...
                                                Tab 1 <span
                                                    class="hs-tab-active:bg-primary hs-tab-active:text-white dark:hs-tab-active:bg-primary dark:hs-tab-active:text-white ms-1 py-0.5 px-1.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-black/20 dark:text-gray-300">99+</span>
                                            </button>
                                            <button type="button"
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="">
                                        <div id="card-type-1" role="tabpanel" aria-labelledby="card-type-item-1">
                                            <p
                                                class="text-gray-500 dark:text-[#8c9097] dark:text-white/50 p-5 border rounded-sm rounded-ss-none dark:border-white/10 border-gray-200">
                                                How hotel deals can help you live a better life. How celebrity cruises
                                                aren't as bad as you think. How cultural solutions can help you predict the
                                                future. How to cheat at dog friendly hotels and get away with it. 17
                                                problems with summer activities. How to cheat at travel agents and get away
                                        ...
                                        <div id="card-type-2" class="hidden" role="tabpanel"
                                        ...
                                        <div id="card-type-3" class="hidden" role="tabpanel"
                        ...
                        <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <nav
                                        class="relative z-0 sm:flex border rounded-sm divide-y sm:divide-y-0 sm:divide-x rtl:divide-x-reverse divide-gray-200 overflow-hidden dark:border-white/10 dark:divide-white/10 ">
                                        ...
                                        <a class="justify-center items-center sm:flex inline-flex w-full sm:w-auto hs-tab-active:border-b-2 hs-tab-active:!border-b-primary hs-tab-active:text-gray-900 dark:hs-tab-active:text-defaulttextcolor/70 group relative min-w-0 flex-1 bg-white dark:bg-black py-4 px-4 text-gray-400 text-sm font-medium text-center pointer-events-none overflow-hidden focus:z-10 dark:bg-bgdark dark:text-white/50"
                                            href="javascript:void(0);" id="bar-item-4" data-hs-tab="#bar-4">
                                            Disabled
                                        </a>
                                    </nav>
                        ...
                        <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <nav class="flex space-x-2 rtl:space-x-reverse" aria-label="Tabs">
                                        <button type="button"
                                            class="hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active"
                                            id="pills-with-brand-color-item-1" data-hs-tab="#pills-with-brand-color-1"
                                            aria-controls="pills-with-brand-color-1">
                                            Tab 1
                                        </button>
                                        <button type="button"
                                            class="hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white"
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <nav class="sm:flex sm:space-x-2 rtl:space-x-reverse" aria-label="Tabs">
                                        <button type="button"
                                            class="w-full hs-tab-active:bg-primary hs-tab-active:text-white flex-auto py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active"
                                            id="fill-and-justify-item-1" data-hs-tab="#fill-and-justify-1"
                                            aria-controls="fill-and-justify-1">
                                            Tab 1
                                        </button>
                                        <button type="button"
                                            class="w-full hs-tab-active:bg-primary hs-tab-active:text-white flex-auto py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white"
                                        ...
                                        <button type="button"
                                            class="w-full hs-tab-active:bg-primary hs-tab-active:text-white flex-auto py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white"
                                            id="fill-and-justify-item-3" data-hs-tab="#fill-and-justify-3"
                        ...
                        <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <nav class="flex space-x-2 rtl:space-x-reverse" aria-label="Tabs">
                                        <button type="button"
                                            class="hs-tab-active:bg-primary hs-tab-active:text-white basis-0 grow py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active"
                                            id="equal-width-elements-item-1" data-hs-tab="#equal-width-elements-1"
                                            aria-controls="equal-width-elements-1">
                                            Tab 1
                                        </button>
                                        <button type="button"
                                            class="hs-tab-active:bg-primary hs-tab-active:text-white basis-0 grow py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white"
                                    ...
                                    <div class="mt-3">
                                        <div id="equal-width-elements-1" role="tabpanel"
                        ...
                        <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="border-b border-gray-200 dark:border-white/10">
                                        <nav class="-mb-0.5 flex justify-end space-x-6 rtl:space-x-reverse"
                                            aria-label="Tabs">
                                            <button type="button"
                                                class="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50 active"

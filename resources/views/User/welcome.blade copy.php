    ...
    <div class="main-content !p-0 landing-main dark:text-defaulttextcolor/70">
                    ...
                    <div class="grid grid-cols-12 gap-6">
                        <div class="xxl:col-span-7 xl:col-span-7 lg:col-span-7 col-span-12">
                            <div class="lg:py-[3rem]">
                                <div class="mb-4">
                                    <h5 class="font-semibold text-white opacity-[0.9] text-[1.25rem]">BRILLIANCE IN EXECUTION
                                    </h5>
                                </div>
                                <p class="landing-banner-heading mb-4 opacity-[0.9]">Your sure stop place for best theme
                                    ends here with <span class="text-secondary">YNEX !</span></p>
                                <div class="text-[1rem] mb-[3rem] text-white opacity-[0.9]">ynex - Now you can use this
        ...
        <section
            ...
            <div class="container text-center relative">
                ...
                <h3 class="font-semibold mb-2 text-defaulttextcolor dark:text-defaulttextcolor/70 ">More than 120+ projects
                    completed.</h3>
                <div class="">
                    <div class="xl:col-span-7 col-span-12">
                        <p class="text-[#8c9097] dark:text-white/50 text-[0.9375rem] mb-12 font-normal">We are proud to have
                            top class clients and customers,which motivates us to work more on projects.</p>
                    </div>
                </div>
        ...
        <section class="section text-defaulttextcolor dark:text-defaulttextcolor/70 text-[0.813rem]" id="about">
            <div class="container text-center">
                ...
                <h3 class="font-semibold mb-2 dark:text-defaulttextcolor dark:text-defaulttextcolor/70710">Designed with
                    precision and well documented</h3>
                <div class="grid grid-cols-12 justify-center max-w-xl mx-auto">
                    <div class="col-span-12">
                        <p class="text-[#8c9097] dark:text-white/50 text-[0.9375rem] mb-4 font-normal">ynex comes with
                            multiple customization options that are very easy to implement.</p>
                    </div>
                </div>
                <div class="grid grid-cols-8 justify-center align-center">
                    ...
                    <div
                        ...
                        <p class=" text-[#8c9097] dark:text-white/50 mb-4">lorem ipsum, dolor sit var ameto condesetrat
                        ...
                        <ul class="">
                            <li class="mb-4">
                                <div class="flex">
                                    ...
                                    <div class="ms-2">
                                        <h6 class="font-semibold mb-0 text-[1rem]">Can Switch Easily From Vertical to
                                            HorizontalMenu.</h6>
                                        <p class=" text-[#8c9097] dark:text-white/50">lorem ipsum, dolor sit var ameto
                                            condesetrat aiatel varen or damsenlel verman code Lorem ipsum, dolor sit amet
                                            consectetur </p>
                                    </div>
                                </div>
                            </li>
                            <li class="mb-4">
                                <div class="flex">
                                    ...
                                    <div class="ms-2">
                                        <h6 class="font-semibold mb-0 text-[1rem]">Switch Easily From One Color to Another
                                            Color style</h6>
                                        <p class=" text-[#8c9097] dark:text-white/50">lorem ipsum, dolor sit var ameto
                                            condesetrat aiatel varen or damsenlel verman code Lorem ipsum, dolor sit amet
                                            consectetur </p>
                            ...
                            <li class="">
                                <div class="flex">
                                    ...
                                    <div class="ms-2">
                                        <h6 class="font-semibold mb-0 text-[1rem]">Switch Easily From Fixed to Scrollable
                                            Layout.</h6>
                                        <p class=" text-[#8c9097] dark:text-white/50">lorem ipsum, dolor sit var ameto
                                            condesetrat aiatel varen or damsenlel verman code Lorem ipsum, dolor sit amet
                                            consectetur </p>
        ...
        <!-- Start:: Section-4 -->
        <section class="section bg-[#f9fafb] section-bg text-defaulttextcolor dark:text-defaulttextcolor/70 text-[0.813rem]"
            id="our-mission">
            <div class="container text-center">
                ...
                <div>
                    <div class="xl:col-span-7">
                        <p class="text-[#8c9097] dark:text-white/50 text-sm mb-12 font-normal">Our mission is to make web
                            design easy, so you can focus on building your brand.</p>
                    </div>
                </div>
                <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="box-body">
                                <div class="items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 text-[#8c9097] dark:text-white/50">lorem ipsum, dolor sit var ameto
                                            condesetrat aiatel varen or damsenlel verman code Lorem ipsum, dolor sit amet
        ...
        <!-- Start:: Section-5 -->
        <section class="section landing-Features text-defaulttextcolor dark:text-defaulttextcolor/70 text-[0.813rem]"
            id="features">
            <div class="container text-center">
                <p class="text-[0.75rem] font-semibold text-success mb-1"><span
                ...
                <div>
                    <div class="xl:col-span-7 col-span-12">
                        <p class="text-white opacity-[0.8] text-[0.9375rem] mb-4 font-normal">Some of the reviews our
                        ...
                        <div class="">
                            <div class="feature-logos sm:mt-[3rem] flex-wrap">
                                <div class="sm:ms-[3rem] ms-2 text-center">
                                    ...
                                    <h5 class="mt-3 text-white text-[1.25rem]">PHP</h5>
                                </div>
                                <div class="sm:ms-[3rem] ms-2 text-center">
                                ...
                                <div class="sm:ms-[3rem] ms-2 text-center">
                                    ...
                                    <h5 class="mt-3 text-white text-[1.25rem]">esbuild</h5>
                                </div>
                                <div class="sm:ms-[3rem] ms-2 text-center">
        ...
        <section
            ...
            <div class="container text-center">
                ...
                <div>
                    <div class="xl:col-span-7 col-span-12">
                        <p class="text-[#8c9097] dark:text-white/50 text-[0.9375rem] mb-[3rem] font-normal">Some of the
                            reviews our clients gave which brings motivation to work for future projects.</p>
                    </div>
                </div>
        ...
        <section
            ...
            <div class="container text-center">
                ...
                <div>
                    <div class="xl:col-span-7 col-span-12">
                        <p class="text-[#8c9097] dark:text-white/50 text-[0.9375rem] mb-12 font-normal">Our team consists
                            of highly qulified employees that works hard to raise company standards.</p>
                    </div>
                </div>
                <div class="grid grid-cols-12 gap-6">
                    <div class="xxl:col-span-3 xl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                        <div class="box text-center team-card ">
                            <div class="box-body p-[3rem]">
                                ...
                                <span
                                    class="text-[#8c9097] dark:text-white/50 text-[0.875rem] !text-primary font-semibold">Director</span>
                                <p class="text-[#8c9097] dark:text-white/50 mt-2 text-[0.8125rem] mb-4"> Lorem ipsum dolor
                                    sit amet, consectetur adipisicing elit.</p>
                                <div class="mt-2">
                                    <a href="profile.html" class="ti-btn ti-btn-light !font-medium" target="_blank">View
                                        profile</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="xxl:col-span-3 xl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                        <div class="box text-center team-card ">
                            <div class="box-body p-[3rem]">
                                ...
                                <span
                                    class="text-[#8c9097] dark:text-white/50 text-[0.875rem] !text-primary font-semibold">Manager</span>
                                <p class="text-[#8c9097] dark:text-white/50 mt-2 text-[0.8125rem] mb-4"> Lorem ipsum dolor
                                    sit amet, consectetur adipisicing elit.</p>
                                <div class="mt-2">
                                    <a href="profile.html" class="ti-btn ti-btn-light !font-medium" target="_blank">View
                    ...
                    <div class="xxl:col-span-3 xl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                        <div class="box text-center team-card ">
                            <div class="box-body p-[3rem]">
                                ...
                                <span
                                    class="text-[#8c9097] dark:text-white/50 text-[0.875rem] !text-primary font-semibold">Web
                                    Designer</span>
                                <p class="text-[#8c9097] dark:text-white/50 mt-2 text-[0.8125rem] mb-4"> Lorem ipsum dolor
                                    sit amet, consectetur adipisicing elit.</p>
                                <div class="mt-2">
                    ...
                    <div class="xxl:col-span-3 xl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                        <div class="box text-center team-card ">
                            <div class="box-body p-[3rem]">
                                ...
                                <span
                                    class="text-[#8c9097] dark:text-white/50 text-[0.875rem] !text-primary font-semibold">HR</span>
                                <p class="text-[#8c9097] dark:text-white/50 mt-2 text-[0.8125rem] mb-4"> Lorem ipsum dolor
                                    sit amet, consectetur adipisicing elit.</p>
                                <div class="mt-2">
                                    <a href="profile.html" class="ti-btn ti-btn-light !font-medium" target="_blank">View
        ...
        <section class="section text-defaulttextcolor dark:text-defaulttextcolor/70 text-[0.813rem] " id="pricing">
            <div class="container text-center">
                ...
                <div class="grid grid-cols-12 justify-center">
                    <div class="col-span-12">
                        <p class="text-[#8c9097] dark:text-white/50 text-[0.9375rem] mb-12 font-normal">Our plans are most
                            affordable and are mainly placed by focussing every category in the sector even basic plan helps
                            better.</p>
                    </div>
                </div>
                ...
                <div class="box overflow-hidden shadow-none justify-center">
                    <div class="box-body !p-0">
                        <div class="tab-content dark:!border-defaultborder/10" id="myTabContent">
                            <div class="tab-pane show active !p-0 dark:!border-defaultborder/10" id="pricing-monthly-pane"
                                aria-labelledby="pm-item" role="tabpanel" tabindex="0">
                                <div class="grid grid-cols-12 justify-center">
                                    <div
                                        class="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-12 col-span-12  md:border-e md:border-b-0 border-b border-dashed dark:border-defaultborder/10">
                                        <div class="p-6">
                                            ...
                                            <div class="py-6 flex items-center justify-center">
                                                ...
                                                <div class="text-end ms-[3rem]">
                                                    ...
                                                    <p
                                                        class="text-[#8c9097] dark:text-white/50 text-[0.6875rem] font-semibold mb-0">
                                                        per month</p>
                                                </div>
                                            </div>
                                            <ul class="list-unstyled text-center text-[0.75rem] px-4 pt-4 mb-0">
                                                ...
                                                <li class="mb-4">
                                                    <span class="text-[#8c9097] dark:text-white/50">Daily Updates<span
                                            ...
                                            <div class="grid">
                                                <button type="button" class="ti-btn ti-btn-primary !font-medium">Get
                                                    Started</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="p-6 pricing-offer overflow-hidden">
                                            ...
                                            <div class="grid">
                                                <button type="button"
                                                    class="ti-btn bg-primary text-white !font-medium shadow">Get
                                                    Started</button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane !p-0 border dark:border-defaultborder/10 hidden" id="pricing-yearly-pane"
                                aria-labelledby="py-item" role="tabpanel" tabindex="0">
                                    ...
                                    <div
                                        ...
                                        <div class="p-6 pricing-offer overflow-hidden">
                                            ...
                                            <div class="py-6 flex items-center justify-center">
                                                ...
                                                <div class="text-end ms-[3rem]">
                                                    <p class="text-[1.5625rem] font-semibold mb-0 !text-primary">$11,499
                                                    </p>
                                                    <p
                                                        class="text-[#8c9097] dark:text-white/50 text-[0.6875rem] font-semibold mb-0">
                                                        per year</p>
        ...
        <section class="section text-defaulttextcolor dark:text-defaulttextcolor/70 text-[0.813rem]" id="contact">
            <div class="container text-center">
                <p class="text-[0.75rem] font-semibold text-success mb-1"><span class="landing-section-heading">CONTACT
                        US</span></p>
                <h3 class="font-semibold mb-2">Have any questions ? We would love to hear from you.</h3>
                <div class="grid grid-cols-12 justify-center">
                    <div class="col-span-12">
                        <p class="text-[#8c9097] dark:text-white/50 text-[0.9375rem] mb-12 font-normal">You can contact us
                            anytime regarding any queries or deals,dont hesitate to clear your doubts before trying our
                            product.</p>
                    </div>
                </div>
                <div class="grid grid-cols-12 gap-6 text-start">
                    <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-12 sm:col-spam-12 col-span-12">
                        <div class="box border dark:border-defaultborder/10 shadow-none">
                            <div class="box-body !p-0">
                                ...
                                <iframe title="map"
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3431.5198246753403!2d76.73770197527628!3d30.675647188389842!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390fedd108485169%3A0x7bcf340262e8bd93!2sIUGOFI%20Networking%20Private%20Limited!5e0!3m2!1sen!2sin!4v1711947204839!5m2!1sen!2sin"
                                    width="600" height="365" allowfullscreen="" loading="lazy"

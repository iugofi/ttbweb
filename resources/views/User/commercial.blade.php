        ...
        <div class="section text-defaulttextcolor dark:text-defaulttextcolor/70 text-[0.813rem] ">
            <div class="container main-banner-container">
                <div class="grid grid xl:grid-cols-12 sm:grid-cols-12 md:grid-cols-12 justify-center align-center justify-center align-center">
                    ...
                    <div
                        class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 pt-5 pb-0 lg:px-2 !text-start  my-auto">
                        ...
                        <div class="grid grid-rows-2 grid-flow-col gap-4">
                            ...
                            <div class="col-span-2"><h5 class="dark-text px-6">Best Services</h5></div>
                          ...
                          <div class="grid grid-rows-2 grid-flow-col gap-4">
                            ...
                            <div class="col-span-2"><h5 class="dark-text px-6">Support 24/7</h5></div>
                            <div class="row-span-2 col-span-2"><p class="text-gray-light px-6">Lorem ipsum dolor sit amet, eiusmod
                                tempor. Lorem ipsum dolor sit amet, eiusmod tempor.</p></div>
                          </div>

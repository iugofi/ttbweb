                        ...
                        <div class="container mx-auto mt-10">
                            <div class="owl-carousel owl-theme">
                                <div class="item bg-white p-5 rounded-lg shadow-md">
                                    ...
                                    <p class="dark-black text-teal-400 font-bold text-xl mb-3 text-center" style="font-size: 16px;">Enhanced Firewall</p>
                                ...
                                <div class="item bg-white p-5 rounded-lg shadow-md">
                                    <img class="h-16 w-16 rounded-full shadow-2xl"
                                        src="https://pbs.twimg.com/profile_images/830533062807191552/TbkWKnnv_400x400.jpg"
                                        alt="Img" style="width: 65px !important;">
                                    <p class="dark-black text-teal-400 font-bold text-xl mb-3 text-center" style="font-size: 16px;">Advanced Antivirus Solutions</p>
                                ...
                                <div class="item bg-white p-5 rounded-lg shadow-md">
                                    <img class="h-16 w-16 rounded-full shadow-2xl"
                                        src="https://pbs.twimg.com/profile_images/830533062807191552/TbkWKnnv_400x400.jpg"
                                        alt="Img" style="width: 65px !important;">
                                    <p class="dark-black text-teal-400 font-bold text-xl mb-3 text-center" style="font-size: 16px;">Real-Time Scanning & Threat Detection</p>
                                ...
                                <div class="item bg-white p-5 rounded-lg shadow-md">
                                    <img class="h-16 w-16 rounded-full shadow-2xl"
                                        src="https://pbs.twimg.com/profile_images/830533062807191552/TbkWKnnv_400x400.jpg"
                                        alt="Img" style="width: 65px !important;">
                                    <p class="dark-black text-teal-400 font-bold text-xl mb-3 text-center" style="font-size: 16px;">Patch Management</p>
                                ...
                                <div class="item bg-white p-5 rounded-lg shadow-md">
                                    <img class="h-16 w-16 rounded-full shadow-2xl"
                                        src="https://pbs.twimg.com/profile_images/830533062807191552/TbkWKnnv_400x400.jpg"
                                        alt="Img" style="width: 65px !important;">
                                    <p class="dark-black text-teal-400 font-bold text-xl mb-3 text-center" style="font-size: 16px;">Data Security Access Control</p>
                                ...
                                <div class="item bg-white p-5 rounded-lg shadow-md">
                                    <img class="h-16 w-16 rounded-full shadow-2xl"
                                        src="https://pbs.twimg.com/profile_images/830533062807191552/TbkWKnnv_400x400.jpg"
                                        alt="Img" style="width: 65px !important;">
                                    <p class="dark-black text-teal-400 font-bold text-xl mb-3 text-center" style="font-size: 16px;">Centralized Management</p>
                                ...
                                <div class="item bg-white p-5 rounded-lg shadow-md">
                                    <img class="h-16 w-16 rounded-full shadow-2xl"
                                        src="https://pbs.twimg.com/profile_images/830533062807191552/TbkWKnnv_400x400.jpg"
                                        alt="Img" style="width: 65px !important;">
                                    <p class="dark-black text-teal-400 font-bold text-xl mb-3 text-center" style="font-size: 16px;">E-Support Concierge</p>

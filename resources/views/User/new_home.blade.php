        ...
        <div class="main-content">
            ...
            <section
                ...
                <div class="container">
                    <div class="grid grid-cols-12 gap-6">
                        <div class="xxl:col-span-12 xl:col-span-12 lg:col-span-12 md:col-span-12 col-span-12 text-center">
                            <h2 class="dark-black">Services</h2>
                        </div>
                    </div>
                    <div class="grid grid-cols-12 gap-6">
                        <div class="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-12 col-span-12">
                            <div class="grid grid-cols-12">
                                ...
                                <div
                                    ...
                                    <h4 class="dark-black">Real-time threat<br> detection</h4>
                                    <p class="dark-black">Lorem ipsum dolor sit amet.</p>
                                </div>
                            </div>
                        </div>
                        <div class="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-12 col-span-12">
                            <div class="grid grid-cols-12">
                                ...
                                <div
                                    class="xxl:col-span-8 xl:col-span-8 lg:col-span-8 md:col-span-8 col-span-8 text-box-new">
                                    <h4 class="dark-black">Auto-update <br>feature </h4>
                                    <p class="dark-black">Lorem ipsum dolor sit amet.</p>
                                </div>
                            </div>
                        </div>
                        <div class="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-12 col-span-12">
                            <div class="grid grid-cols-12">
                                ...
                                <div
                                    class="xxl:col-span-8 xl:col-span-8 lg:col-span-8 md:col-span-8 col-span-8 text-box-new">
                                    <h4 class="dark-black">24x7 hours expert & certified services</h4>
                                    <p class="dark-black">Lorem ipsum dolor sit amet.</p>
                                </div>
                            </div>
                        </div>
                        <div class="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-12 col-span-12">
                            <div class="grid grid-cols-12">
                                ...
                                <div
                                    class="xxl:col-span-8 xl:col-span-8 lg:col-span-8 md:col-span-8 col-span-8 text-box-new">
                                    <h4 class="dark-black">Multi-device <br>compatibility </h4>
                                    <p class="dark-black">Lorem ipsum dolor sit amet.</p>
                                </div>
                            </div>
                        </div>
            ...
            <section class="section-home-new-5">
                <div class="container">
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-12 ps-8 col-span-12">
                        ...
                        <div class="container mx-auto mt-10">
                            <div class="owl-carousel owl-theme">
                                <div class="item bg-white p-5 rounded-lg shadow-md">
                                    ...
                                    <p class="dark-black text-teal-400 font-bold text-xl mb-3 pt-5 text-center" style="font-size: 16px;">Enhanced Firewall</p>
                                ...
                                <div class="item bg-white p-5 rounded-lg shadow-md">
                                    <img class="h-16 w-16 rounded-full shadow-2xl"
                                        src="https://pbs.twimg.com/profile_images/830533062807191552/TbkWKnnv_400x400.jpg"
                                        alt="Img" style="width: 65px !important;">
                                    <p class="dark-black text-teal-400 font-bold text-xl mb-3 pt-5 text-center" style="font-size: 16px;">Advanced Antivirus Solutions</p>
                                ...
                                <div class="item bg-white p-5 rounded-lg shadow-md">
                                    <img class="h-16 w-16 rounded-full shadow-2xl"
                                        src="https://pbs.twimg.com/profile_images/830533062807191552/TbkWKnnv_400x400.jpg"
                                        alt="Img" style="width: 65px !important;">
                                    <p class="dark-black text-teal-400 font-bold text-xl mb-3 pt-5 text-center" style="font-size: 16px;">Real-Time Scanning & Threat Detection</p>
                                ...
                                <div class="item bg-white p-5 rounded-lg shadow-md">
                                    <img class="h-16 w-16 rounded-full shadow-2xl"
                                        src="https://pbs.twimg.com/profile_images/830533062807191552/TbkWKnnv_400x400.jpg"
                                        alt="Img" style="width: 65px !important;">
                                    <p class="dark-black text-teal-400 font-bold text-xl mb-3 pt-5 text-center" style="font-size: 16px;">Patch Management</p>
                                ...
                                <div class="item bg-white p-5 rounded-lg shadow-md">
                                    <img class="h-16 w-16 rounded-full shadow-2xl"
                                        src="https://pbs.twimg.com/profile_images/830533062807191552/TbkWKnnv_400x400.jpg"
                                        alt="Img" style="width: 65px !important;">
                                    <p class="dark-black text-teal-400 font-bold text-xl mb-3 pt-5 text-center" style="font-size: 16px;">Data Security Access Control</p>
                                ...
                                <div class="item bg-white p-5 rounded-lg shadow-md">
                                    <img class="h-16 w-16 rounded-full shadow-2xl"
                                        src="https://pbs.twimg.com/profile_images/830533062807191552/TbkWKnnv_400x400.jpg"
                                        alt="Img" style="width: 65px !important;">
                                    <p class="dark-black text-teal-400 font-bold text-xl mb-3 pt-5 text-center" style="font-size: 16px;">Centralized Management</p>
                                ...
                                <div class="item bg-white p-5 rounded-lg shadow-md">
                                    <img class="h-16 w-16 rounded-full shadow-2xl"
                                        src="https://pbs.twimg.com/profile_images/830533062807191552/TbkWKnnv_400x400.jpg"
                                        alt="Img" style="width: 65px !important;">
                                    <p class="dark-black text-teal-400 font-bold text-xl mb-3 pt-5 text-center" style="font-size: 16px;">E-Support Concierge</p>

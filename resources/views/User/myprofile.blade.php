                                ...
                                <div
                                    ...
                                    <nav class="-mb-0.5 sm:flex md:space-x-6 rtl:space-x-reverse pb-2">
                                        <a class="w-full sm:w-auto flex active hs-tab-active:font-semibold  hs-tab-active:text-white hs-tab-active:bg-primary rounded-md py-2 px-4 text-primary text-sm"
                                            ...
                                            <i class="ri-shield-user-line  align-middle inline-block me-1"></i>Profile Information
                                        </a>
                                        ...
                                        <a class="w-full sm:w-auto flex hs-tab-active:font-semibold  hs-tab-active:text-white hs-tab-active:bg-primary rounded-md  py-2 px-4 text-primary text-sm"
                                            ...
                                            <i
                                                class="ri-bill-line me-1 align-middle inline-block"></i>Billing Information
                                        </a>
                                        <a class="w-full sm:w-auto flex hs-tab-active:font-semibold  hs-tab-active:text-white hs-tab-active:bg-primary rounded-md  py-2 px-4 text-primary text-sm"
                                            href="javascript:void(0);" id="gallery-tab"
                                            data-hs-tab="#gallery-tab-pane" aria-controls="gallery-tab-pane">
                                            <i
                                                class="ri-list-ordered me-1 align-middle inline-block"></i>Order History
                                        </a>
                                    </nav>
                                    <div>
                                        <p class="font-semibold mb-2">Profile 60% completed - <a
                                                href="javascript:void(0);"
                                                class="text-primary text-[0.75rem]">Finish now</a></p>
                                            ...
                                            aria-labelledby="activity-tab" tabindex="0">
                                                ...
                                                <div class="mt-3">
                                                  <div id="horizontal-alignment-1" role="tabpanel" aria-labelledby="horizontal-alignment-item-1">
                                                    <button type="button" class="hs-dropdown-toggle ti-btn ti-btn-primary-full m-1" data-hs-overlay="#hs-vertically-centered-scrollable-modal" style="float: right">
                                                        Edit Profile
                                                      </button>
                                                        ...
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out h-[calc(100%-3.5rem)] min-h-[calc(100%-3.5rem)] flex items-center">
                                                          <div class="max-h-full overflow-hidden ti-modal-content">
                                                            <div class="ti-modal-header">
                                                                <h6 class="modal-title" id="staticBackdropLabel3">Edit Profile
                                                                </h6>
                                                            ...
                                                            <div class="ti-modal-body">
                                                                <form>
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" value="{{ isset($user_data->firstname) ? $user_data->firstname : '' }}" id="name">
                                                                    </div>
            
                                                                    <div class="mb-3">
                                                                        <label for="exampleInputPassword1" class="form-label">Last Name</label>
                                                                        <input type="text" class="form-control" value="{{ isset($user_data->lastname) ? $user_data->lastname : '' }}" id="name">
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="email" class="form-control" value="{{ isset($user_data->email) ? $user_data->email : '' }}" id="exampleInputEmail1"
                                                                            aria-describedby="emailHelp">
                                                                      
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="exampleInputPassword1" class="form-label">Phone</label>
                                                                        <input type="text" class="form-control" value="{{ isset($user_data->phone) ? $user_data->phone : '' }}" id="phone">
                                                                    </div>
                                                                    <div class="mb-3">
                                                      ...
                                                      <button type="button" class="hs-dropdown-toggle ti-btn ti-btn-primary-full m-1" data-hs-overlay="#hs-vertically-centered-scrollable-modal-password" style="float: right">
                                                        Change Password
                                                      </button>
                                                      <div id="hs-vertically-centered-scrollable-modal-password" class="hs-overlay hidden ti-modal">
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out h-[calc(100%-3.5rem)] min-h-[calc(100%-3.5rem)] flex items-center">
                                                          <div class="max-h-full overflow-hidden ti-modal-content">
                                                            <div class="ti-modal-header">
                                                                <h6 class="modal-title" id="staticBackdropLabel3">Change Password
                                                                </h6>
                                                              <button type="button" class="hs-dropdown-toggle ti-modal-close-btn" data-hs-overlay="#hs-vertically-centered-scrollable-modal-password">
                                                                <span class="sr-only">Close</span>
                                                                <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                  <path d="M0.258206 1.00652C0.351976 0.912791 0.479126 0.860131 0.611706 0.860131C0.744296 0.860131 0.871447 0.912791 0.965207 1.00652L3.61171 3.65302L6.25822 1.00652C6.30432 0.958771 6.35952 0.920671 6.42052 0.894471C6.48152 0.868271 6.54712 0.854471 6.61352 0.853901C6.67992 0.853321 6.74572 0.865971 6.80722 0.891111C6.86862 0.916251 6.92442 0.953381 6.97142 1.00032C7.01832 1.04727 7.05552 1.1031 7.08062 1.16454C7.10572 1.22599 7.11842 1.29183 7.11782 1.35822C7.11722 1.42461 7.10342 1.49022 7.07722 1.55122C7.05102 1.61222 7.01292 1.6674 6.96522 1.71352L4.31871 4.36002L6.96522 7.00648C7.05632 7.10078 7.10672 7.22708 7.10552 7.35818C7.10442 7.48928 7.05182 7.61468 6.95912 7.70738C6.86642 7.80018 6.74102 7.85268 6.60992 7.85388C6.47882 7.85498 6.35252 7.80458 6.25822 7.71348L3.61171 5.06702L0.965207 7.71348C0.870907 7.80458 0.744606 7.85498 0.613506 7.85388C0.482406 7.85268 0.357007 7.80018 0.264297 7.70738C0.171597 7.61468 0.119017 7.48928 0.117877 7.35818C0.116737 7.22708 0.167126 7.10078 0.258206 7.00648L2.90471 4.36002L0.258206 1.71352C0.164476 1.61976 0.111816 1.4926 0.111816 1.36002C0.111816 1.22744 0.164476 1.10028 0.258206 1.00652Z" fill="currentColor"/>
                                                                </svg>
                                                                    ...
                                                                    <div class="grid grid-cols-12 gap-y-4">
                                                                        <div class="xl:col-span-12 col-span-12">
                                                                            ...
                                                                            <div class="input-group">
                                                                                <input type="password" class="form-control form-control-lg !rounded-e-none" value="{{ isset($user_data->password) ? \Crypt::decrypt($user_data->password)  : '' }}" id="reset-password" placeholder="current password" disabled>
                                                            ...
                                                            <div class="ti-modal-footer">
                                                              ...
                                                              <input type="submit" class="ti-btn ti-btn-primary-full"  value="Change Password">
                                                            </div>
                                                        </form>
                                                          </div>
                                                        </div>
                                                            ...
                                                            <ul class="list-group">
                                                                <li class="list-group-item">
                                                                    <div class="flex flex-wrap items-center">
                                                                        ...
                                                                        <span class="text-[0.75rem] text-[#8c9097] dark:text-white/50" id="name">
                                                                ...
                                                                <li class="list-group-item">
                                                                    <div class="flex flex-wrap items-center">
                                                                        ...
                                                                        <span
                                                                            class="text-[0.75rem] text-[#8c9097] dark:text-white/50"> @if(isset($user_data) && !empty($user_data->phone))
                                                                            {{$user_data->phone}}
                                                                            @else
                                                                                ! Email
                                                                            @endif
                                                                ...
                                                                <li class="list-group-item">
                                                                    <div class="flex flex-wrap items-center">
                                                                        ...
                                                                        <span
                                                                            class="text-[0.75rem] text-[#8c9097] dark:text-white/50"> @if(isset($user_data) && !empty($user_data->address))
                                                                            {{$user_data->address}}
                                                                            @else
                                                                                ! Email
                                                                            @endif</span>
                                                  ...
                                                  <div id="horizontal-alignment-2" class="hidden" role="tabpanel" aria-labelledby="horizontal-alignment-item-2">
                                                    <form>
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="exampleInputPassword1" class="form-label">Last Name</label>
                                                            <input type="text" class="form-control" value="{{ isset($user_data->lastname) ? $user_data->lastname : '' }}" id="lastname">
                                                        </div>
                                                        ...
                                                        <div class="box-body p-6">
                                                            <div class="text-center">
                                                                <span class="avatar avatar-xl avatar-rounded">
                                                                    <img src="assets/images/ecommerce/png/ttb-box.png" alt="">
                                                                </span>
                                                                <div class="mt-2">

...
@section('content')
    ...
    <div class="main-content !p-0 landing-main dark:text-defaulttextcolor/70" id="totel-internet-security">
        ...
        <div class="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900" id="particles-js">
            <div class="container mx-auto px-4 lg:px-26">
                <div class="flex flex-col lg:flex-row items-center justify-center space-y-8 lg:space-y-0 lg:space-x-14">
                    <!-- Left Column -->
                    <div class="text-center lg:text-center lg:w-1/2 mb-8 lg:mb-0">
                    ...
                    <!-- Right Column -->
                    <div class="lg:w-1/2">
                        <img src="php-img/payment cancel.jpg" alt="Payment Cancelled Image" class="w-full h-auto rounded-lg shadow-lg">
                    </div>
                </div>
            </div>
        </div>

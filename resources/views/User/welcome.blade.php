...
<body>
    <div class="dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <li><a class="dropdown-item" href="https://www.routerloginsupport.com/category/netgear/">Netgear</a></li>
            <li><a class="dropdown-item" href="https://www.routerloginsupport.com/category/tp-link/">TP-Link</a></li>
            <li><a class="dropdown-item" href="https://www.routerloginsupport.com/category/belkin/">Belkin</a></li>
            <li><a class="dropdown-item" href="https://www.routerloginsupport.com/category/linksys/">Linksys</a></li>
            <li><a class="dropdown-item" href="https://www.routerloginsupport.com/category/d-link/">D-Link</a></li>
            <li><a class="dropdown-item" href="https://www.routerloginsupport.com/category/asus/">Asus</a></li>
            <li><a class="dropdown-item" href="https://www.routerloginsupport.com/category/spectrum/">Spectrum</a></li>
            <li><a class="dropdown-item" href="https://www.routerloginsupport.com/category/calix/">Calix</a></li>
        </ul>
    </div>
    <style>
        .dropdown-btn a#dropdownMenuLink {
    padding: 6px 27px;
    font-size: 18px;
    border-radius: 37px;

        ...
        <div class="flex flex-wrap footer-flex"> 
          <div class="w-full lg:w-1/2 mb-8 lg:mb-0 mobile-flex">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 my-btn-section">
                ...
                <a href="#" class="ti-btn !rounded-full ti-btn-wave my-btn-pro" style="border: 1px solid #13D8AA font-size: 26px; display: flex;">
              ...
              <div class="subscribe-form">
                <form method="post" action="#">
                  <div class="form-group relative">
                    <input type="email" name="email" placeholder="Enter mail address..." required class="w-80 h-12 px-8 py-2 rounded-full bg-transparent text-black border border-white outline-none">

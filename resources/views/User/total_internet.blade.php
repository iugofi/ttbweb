...
@section('content')
    ...
    <div class="main-content !p-0 landing-main dark:text-defaulttextcolor/70" id="totel-internet-security">
        ...
        <div
            class="section text-defaulttextcolor dark:text-defaulttextcolor/70 text-[0.813rem] third-back internet2-section">
                    ...
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 col-span-12">
                            ...
                            <div class="text-end flex justify-end w-full">
                                <img src="{{ asset('assets/img/Secnd-section-img-2.png') }}" alt=""
                ...
                <div class="container main-banner-container">
                    <div class="forth heading" style="text-align: center; font-size: 16px;">
                        <h3 class="landing-banner-heading mb-4 pb-5 opacity-[0.9] pt-5"><span class="text-dark"
                                style="font-size:40px; font-weight:600;">System Requirements</h3>
                        <p class="card-text mb-4 pb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa
                            iusto perspiciatis rerum ex sint? Possimus<br> harum aliquid molestiae voluptates. Laborum totam
                            explicabo maiores qui culpa?<br> Corporis corrupti aperiam cupiditate officia.</p>
                    </div>
                        ...
                        <div class="xl:col-span-12 col-span-12">
                            <div class="grid grid-cols-12 gap-6">
                                ...
                                <div class="xl:col-span-7 col-span-12">
                                    <div class="xxl:col-span-7 xl:col-span-7 lg:col-span-7 col-span-12">
                                        <div class="lg:py-[3rem]">
                                            <p class="landing-banner-heading mb-4 opacity-[0.9]" style="font-size:16px;">
                                            ...
                                            <div class=" grid grid-cols-12 gap-6">
                                                <div class=" xxl:col-span-5 xl:col-span-5 lg:col-span-5 col-span-12">
                                                    <i class='bx bx-check-double'
                                                        style="font-size:16px; line-height:1.2rem">With supporting natural
                                                        lead</i>
                                                    <i class='bx bx-check-double'
                                                        style="font-size:16px; line-height:1.2rem">With supporting natural
                                                        lead</i>

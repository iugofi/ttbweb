...
<div class="main-content !p-0 landing-main dark:text-defaulttextcolor/70" id="totel-internet-security">
        ...
        <section class="section !bg-[#f9fafb] dark:!bg-black/10 section-bg text-defaulttextcolor dark:text-defaulttextcolor/70" id="features">
            <div class="forth heading" style="text-align: center;">
                ...
                <p class="card-text mb-4 pb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa iusto perspiciatis rerum ex sint? Possimus harum aliquid molestiae voluptates. Laborum totam explicabo <br>maiores qui culpa? Corporis corrupti aperiam cupiditate officia.</p>
            </div>

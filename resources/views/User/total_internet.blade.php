                ...
                <div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 col-span-12">
                        ...
                        <div class="text-end flex justify-end w-full">
                            <img src="{{ asset('assets/img/secnd-section-img.png') }}" alt="" class="img-fluid" width="100%">
                        </div>
        ...
        <section class="section !bg-[#f9fafb] dark:!bg-black/10 section-bg text-defaulttextcolor dark:text-defaulttextcolor/70" id="features">
            <div class="container text-center">
                <div class="forth heading" style="text-align: center; font-size: 16px;">
                    ...
                    <p class="card-text mb-4 pb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa iusto perspiciatis rerum ex sint?<br> Possimus harum aliquid molestiae voluptates. Laborum totam explicabo maiores qui culpa?<br> Corporis corrupti aperiam cupiditate officia.</p>
                </div>
         ...
         <section class="section text-defaulttextcolor dark:text-defaulttextcolor/70 text-[0.813rem]" id="features">
            <div class="container main-banner-container text-center">
                    <h3 class="landing-banner-heading mb-4 pb-5 opacity-[0.9] pt-5"><span class="text-dark" style="font-size:40px; font-weight:600; text-align:center;">System Requirements</h3>

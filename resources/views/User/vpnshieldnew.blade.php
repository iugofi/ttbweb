        ...
        <div class="vpn-innersection-two">
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 col-span-12 prog-section">
                    ...
                    <p class="text-[0.75rem] font-semibold mb-3 text-[#8C9097] dark:text-white/50 prog-section-p">Fast VPN<span
                    ...
                    <p class="text-[0.75rem] font-semibold mb-3 text-[#8C9097] dark:text-white/50 prog-section-p">Malware Detection
                    ...
                    <p class="text-[0.75rem] font-semibold mb-3 text-[#8C9097] dark:text-white/50 prog-section-p">Total Security
                    ...
                    <p class="text-[0.75rem] font-semibold mb-3 text-[#8C9097] dark:text-white/50 prog-section-p">Absolute Privacy

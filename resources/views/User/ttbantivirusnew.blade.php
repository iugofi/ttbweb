                    ...
                    <div class="grid grid-cols-12 gap-6">
                        <div class="xxl:col-span-12 xl:col-span-12 lg:col-span-12 col-span-12">
                            <div class="lg:py-[3rem] text-vartical"
                                ...
                                <h1 class="text-center font-semibold mb-2 text-[2rem]" style="color: #000;">Limited Time
        ...
        {{-- <section class="section-troubleshoot tabsection-one">
            <div class="worko-tabs">
                <div class="troubleshoot-heading">
                    <h3 style="text-align: center; margin-top: 20px; font-weight: 600; font-size: 34px; color: #11CDBD;">
                        Easily Setup the
                        Smart Devices</h3>
                    <p style="text-align: center; margin-top: 10px; color: #000; padding-bottom: 20px;font-size:16px;">TTB
                        eSupport Concierge will guide you
                        through
                    ...
                    <div id="tab-five-panel" class="panel active" style="display: block;">
                        <div class="tab-five-conatiner">
                            <div class="left-side-container">
                                ...
                                <p style="font-size:16px;"> As a newbie, setting up your home automation devices on your own
                                    can be difficult. But
                                    with our TTB eSupport Concierge it will
                                    be easier than ever.</p>
                                <div class="icons-content">
                                    <div class="icon-1">
                                        <img src="assets/images/eSupport/Watch-Over-Your-Family-from-Anywhere.png"
                                            alt=""><br>
                                        <p style="color:#333;font-size:16px;font-weight:400; text-align:left;width:100px;">
                                            Watch Over <br>Your Family <br>from Anywhere</p>
                                    </div>
                                    <div class="icon-2">
                                        <img src="assets/images/eSupport/Eliminate-Common-&amp;-Complex-Issues.png"
                                            alt=""><br>
                                        <p style="color:#333;font-size:16px;font-weight:400; text-align:left; width:100px;">
                                            Eliminate Common <br>&amp; Complex Issues</p>
                                    </div>
                                    <div class="icon-3">
                                        <img src="assets/images/eSupport/op-Notch-Experience-Without-Lagging.png"
                                            alt=""><br>
                                        <p style="color:#333;font-size:16px;font-weight:400; text-align:left;width:100px;">
                                            Top-Notch Experience<br> Without Lagging</p>
                                    </div>
                                </div>
                            ...
                            <div class="right-side-container">
                                <img src="assets/images/eSupport/network-setup-3.jpg" alt="" width="500px"
                                    height="400px">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab-six-panel" class="panel">
                        <div class="container-2">
                            <div class="left-container-2">
                                ...
                                <p style="font-size:16px;">From your home networks to workplace security devices, we will
                                    help you optimize them for
                                    optimal functioning only.
                                </p>
                                <div class="icons-content">
                                    <div class="icon-1">
                                        <img src="assets/images/eSupport/Enhance-Your-Security-With-Smart-Devices.png"
                                            alt=""><br>
                                        <p style="color:#333;font-size:16px;font-weight:400; text-align:left;width:109px;">
                                            Enhance Your Security <br>With Us</p>
                                    </div>
                                    <div class="icon-2">
                                        <img src="assets/images/eSupport/Customize-the-Settings-Accordingly.png"
                                            alt=""><br>
                                        <p style="color:#333;font-size:16px;font-weight:400; text-align:left;width:100px;">
                                            Customize<br>the Settings Accordingly</p>
                                    </div>
                                    <div class="icon-3">
                                        <img src="assets/images/eSupport/Increase-devices-Functionality-yours.png"
                                            alt=""><br>
                                        <p style="color:#333;font-size:16px;font-weight:400; text-align:left;width:100px;">
                                            Increase device’s<br>Functionality</p>
                                    </div>
                                </div>
                            ...
                            <div class="right-container-2">
                                <img src="assets/images/eSupport/smart-device-2.jpg" alt="" width="500px"
                                    height="400px">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab-seven-panel" class="panel">
                        <div class="container-2">
                            <div class="left-container-2">
                                ...
                                <p style="font-size:16px;">Software installation can be difficult to eliminate without
                                    professional advice. So,
                                ...
                                <div class="icons-content">
                                    <div class="icon-1">
                                        ...
                                        <p style="color:#333;font-size:16px;font-weight:400; text-align:left;">Proper
                                            <br>Software Running</p>
                                    </div>
                                    <div class="icon-2">
                                        <img src="assets/images/eSupport/Eliminates-Any-Glitches-&amp;-Bugs.png"
                                            alt=""><br>
                                        <p style="color:#333;font-size:16px;font-weight:400; text-align:left;">Eliminates
                                            Any <br>Glitches &amp; Bugs</p>
                                    </div>
                                    <div class="icon-3">
                                        <img src="assets/images/eSupport/Watch-Over-Your-Family-from-Anywhere.png"
                                            alt=""><br>
                                        <p style="color:#333;font-size:16px;font-weight:400; text-align:left;">Ensure
                                            Correct <br>Software Installed</p>
                                    </div>
                                </div>
                                <div class="price-section-2">
                                    <div class="price-1">
                            ...
                            <div class="right-container-2">
                                <img src="assets/images/eSupport/software-installation-2.jpg" alt=""
